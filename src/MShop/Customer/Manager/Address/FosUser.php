	...
	extends \Aimeos\MShop\Customer\Manager\Address\Standard
{
	private array $searchConfig = array(
		'customer.address.id' => array(
			...
			'internaldeps' => array( 'LEFT JOIN "fos_user_address" AS mcusad ON ( mcus."id" = mcusad."parentid" )' ),
			'type' => 'int',
			'public' => false,
		),
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/customer/manager/address/fosuser/clear' );
	}
