	...
	implements \Aimeos\MShop\Customer\Manager\Property\Iface
{
	...
	{
		/** mshop/customer/manager/property/fosuser/insert/mysql
		 * Inserts a new customer property record into the database table
		 *
		 * @see mshop/customer/manager/property/fosuser/insert/ansi
		 */

		/** mshop/customer/manager/property/fosuser/insert/ansi
		 * Inserts a new customer property record into the database table
		 *
		 ...
		 * @since 2018.07
		 * @category Developer
		 * @see mshop/customer/manager/property/fosuser/update/ansi
		 * @see mshop/customer/manager/property/fosuser/newid/ansi
		 * @see mshop/customer/manager/property/fosuser/delete/ansi
		 * @see mshop/customer/manager/property/fosuser/search/ansi
		 * @see mshop/customer/manager/property/fosuser/count/ansi
		 */

		/** mshop/customer/manager/property/fosuser/update/mysql
		 * Updates an existing customer property record in the database
		 *
		 * @see mshop/customer/manager/property/fosuser/update/ansi
		 */

		/** mshop/customer/manager/property/fosuser/update/ansi
		 * Updates an existing customer property record in the database
		 *
		...
		/** mshop/customer/manager/property/fosuser/newid/mysql
		 * Retrieves the ID generated by the database when inserting a new record
		 *
		 * @see mshop/customer/manager/property/fosuser/newid/ansi
		 */

		/** mshop/customer/manager/property/fosuser/newid/ansi
		 * Retrieves the ID generated by the database when inserting a new record
		 *
		 ...
		 * For PostgreSQL:
		 *  SELECT currval('seq_fospr_id')
		 * For SQL Server:
		 *  SELECT SCOPE_IDENTITY()
		 * For Oracle:
		 *  SELECT "seq_fospr_id".CURRVAL FROM DUAL
		 *
		...
		/** mshop/customer/manager/property/fosuser/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/customer/manager/property/fosuser/delete/ansi
		 */

		/** mshop/customer/manager/property/fosuser/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		...
		/** mshop/customer/manager/property/fosuser/search/mysql
		 * Retrieves the records matched by the given criteria in the database
		 *
		 * @see mshop/customer/manager/property/fosuser/search/ansi
		 */

		/** mshop/customer/manager/property/fosuser/search/ansi
		 * Retrieves the records matched by the given criteria in the database
		 *
		...
		/** mshop/customer/manager/property/fosuser/count/mysql
		 * Counts the number of records matched by the given criteria in the database
		 *
		 * @see mshop/customer/manager/property/fosuser/count/ansi
		 */

		/** mshop/customer/manager/property/fosuser/count/ansi
		 * Counts the number of records matched by the given criteria in the database
		 *
